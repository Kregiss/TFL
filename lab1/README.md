...
<<<<<<< HEAD
3. Ψ(w) = |w|_a + 2 * |w|_b
4. Лин. комбинация количества различных подстрок длины <= 3
5. Композиция функций от каждой буквы в строке phi(w0) o phi(w1) o ...
   
=======
3. Ψ(w) = |w| + 2 * |w|_b
   
>>>>>>> 5c75910e00b97a6918ddea4dd3be66e57bd58ce2
