...
Таблица множеств классов эквивалентности ДКА. Какая-то часть строки выделена зелёным - эта строка уже уникальна (незакрашеная её часть) и нет смысла проверять её дальнейшие (закрашенные зелёным) ячейки
