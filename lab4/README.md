...
3) содержит оба блока $b^p$, т.е. $w=b^tababaabbb^t, 0<=t<p$, $v=b^s$ (из первого $b^p$), $u=b^s$ (из второго $b^p$), $t+s=p$. При i=0 получаем слово $w_0 = abbabbb^{p^2+8p+12-k}ababaabbabbb^{p-s}ababaabbb^{p-s}ababaaa$. Равенство атрибутов $S_{21}.attr = S_{22}.attr = p-s$ сохранится, да. НО нарушится равенство атрибутов $S_{11}.attr = p^2+8p+16$ и $S_{12}.attr = (p-s+4)^2=p^2+2p(4-s)+(4-s)^2$, что равно только когда s=0, что невозможно. Слово выпало из языка. Противоречие лемме.
